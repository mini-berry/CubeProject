...
// 读取自身姿态
extern uint8_t read_dmp(pose_msg_t *pose_msg, accel_msg_t *mpu_accel_msg);

// ms级别延时
extern void my_hal_delay(unsigned long ms);

// ms级别时间戳
extern void f1_get_tick_ms_cnt(unsigned long *cnt);
// ms级别时间戳(空)
extern void f1_get_tick_ms_cnt1(unsigned long *cnt);
